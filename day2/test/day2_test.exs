defmodule Day2Test do
  ...
  test "finds ids that are the closest matches to each other" do
    assert Day2.closest_ids() == {"oeylbtcxjqnzhgkyylfapviusr", "oeylbtcxjqnzhgyyylfapviusr"}
  end

  test "finds the common characers between two ids" do
    assert Day2.matching_profile({"oeylbtcxjqnzhgkyylfapviusr", "oeylbtcxjqnzhgyyylfapviusr"}) ==
